...
Rscript $script_dir/09_03_cluster_resolution_optimization.R \
    ...
    --output $results_dir/12_cluster_resolution_optimization_noCB_noDF_XRCC5_HumanCells/15_PCs \
    --output_prefix "smp3-6PRV_smp7NoPRV_grch38_noCB_noDF_XRCC5_HumanCells_15PC" \
    --mode "scRNA" \
    --cores ${NSLOTS} \
    --ndim 15 \
