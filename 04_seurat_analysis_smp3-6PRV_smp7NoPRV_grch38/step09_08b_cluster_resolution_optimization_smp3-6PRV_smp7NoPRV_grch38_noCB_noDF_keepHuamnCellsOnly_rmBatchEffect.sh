...
Rscript $script_dir/09_03_cluster_resolution_optimization.R \
    ...
    --output $results_dir/08_cluster_resolution_optimization_no_CB_no_DF_HumanCells/20_PCs_rmBatchEffect \
    --output_prefix "smp3-6PRV_smp7NoPRV_grch38_noCB_noDF_HumanCells_rmBatchEffect_20PC" \
    --mode "scRNA" \
    --cores ${NSLOTS} \
    --ndim 20 \
