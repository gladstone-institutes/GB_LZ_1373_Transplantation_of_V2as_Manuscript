...
--input_dir $base_dir/results/09_seurat_analysis_smp3-6PRV_smp7NoPRV_grch38_noCB_noDF/10_qc_noCB_noDF_XRCC5_HumanCells \
--output_dir $base_dir/results/09_seurat_analysis_smp3-6PRV_smp7NoPRV_grch38_noCB_noDF/11_merge_and_visualize_noCB_noDF_XRCC5_HumanCells \
--output_prefix "smp3-6PRV_smp7NoPRV_grch38_noCB_noDF_XRCC5_HumanCells" \
--project "LZ_1373" \
--npcs 20
