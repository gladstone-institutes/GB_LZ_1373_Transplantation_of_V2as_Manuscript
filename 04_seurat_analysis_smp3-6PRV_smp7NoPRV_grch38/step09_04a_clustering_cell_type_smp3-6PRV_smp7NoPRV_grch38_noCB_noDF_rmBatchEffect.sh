...
Rscript $script_dir/09_04_clustering_cell_type.R \
    --input $results_dir/02_merge_and_visualize_no_cellbender_no_doubletfinder/smp3-6PRV_smp7NoPRV_grch38_noCB_noDF_merged_data_sct_pca_umap.rds \
    --output $results_dir/04_clustering_cell_type_no_cellbender_no_doubletfinder/20PC_0.6res_rmBatchEffect \
    --output_prefix "smp3-6PRV_smp7NoPRV_grch38_noCB_noDF_rmBatchEffect" \
    --tissue "Brain" \
    --ndim 20 \
    --resolution 0.6 \
