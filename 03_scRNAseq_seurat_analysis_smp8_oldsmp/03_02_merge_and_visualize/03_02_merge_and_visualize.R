...
##          previous run; visualize for batch effects.
## Example running this script on wynton:
##    Rscript 03_02_merge_and_visualize.R
###############################################################################
...
basedir <- paste0("/gladstone/bioinformatics/projects/lz-1373-lana-zholudeva-deepak-srivastava-",
                  "scrnaseq-snrnaseq-hg38-may-2023/results/03_scRNAseq_seurat_analysis_smp8_oldsmp")
...
file_paths <- file.path(indir, list.files(pattern = ".rds"))
