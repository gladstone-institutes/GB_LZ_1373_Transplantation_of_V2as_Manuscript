...
basedir <- "~/Dropbox (Gladstone)/GB-LZ-1373/results/08_seurat_analysis_samples_8_and_oldsample_grch38_no_cellbender_no_doubletfinder/02_merge_and_visualize/"
setwd(basedir)

#load the Seurat object
merged_sc_data <- readRDS("merged_data_samples_8_and_oldsample_grch38_post_sct_processed.rds")

y_chr_genes <- read_xlsx("~/Dropbox (Gladstone)/GB-LZ-1373/Y_Chromosome_Specific_Genes.xlsx")
