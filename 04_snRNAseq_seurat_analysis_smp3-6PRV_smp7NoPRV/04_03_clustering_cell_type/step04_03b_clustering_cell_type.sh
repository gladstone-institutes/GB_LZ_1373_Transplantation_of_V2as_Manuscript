...
script_dir=$data_dir/scripts/GB_LZ_1373_Transplantation_of_V2as_Manuscript/04_snRNAseq_seurat_analysis_smp3-6PRV_smp7NoPRV
results_dir=$data_dir/results/04_snRNAseq_seurat_analysis_smp3-6PRV_smp7NoPRV
...
Rscript $script_dir/04_03_clustering_cell_type/04_03_clustering_cell_type.R \
--input $results_dir/03_clustering_cell_type/20PC_${res}res_rmBatchEffect/smp3-7_grch38_noCB_noDF_HumanCells_rmBatchEffect_NoPRV_20PC_${res}res_clustered_and_cell_typed.rds \
--output $results_dir/03_clustering_cell_type/20PC_${res}res_rmBatchEffect_rmCluster15 \
