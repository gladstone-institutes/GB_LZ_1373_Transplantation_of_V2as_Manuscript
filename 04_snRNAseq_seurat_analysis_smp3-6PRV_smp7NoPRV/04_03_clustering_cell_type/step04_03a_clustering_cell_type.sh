...
--input $results_dir/02_merge_and_visualize/smp3-7_grch38_noCB_noDF_HumanCells_NoPRV_merged_data_sct_pca_umap.rds \
--output $results_dir/03_clustering_cell_type/20PC_${res}res_rmBatchEffect \
